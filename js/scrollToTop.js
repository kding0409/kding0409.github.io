var scrolltotop={
	...
	controlHTML:'<img src="images/arrow.png" width="60px" />',
	controlattrs:{
		offsetx:10,
		offsety:10
	},
			...
			jQuery(document).ready(
				function(t){
					...
					o.$control=t('<div id="topcontrol">'+o.controlHTML+"</div>").css({
							...
							opacity:0,
							cursor:"pointer"
						}).attr({title:"Scroll to Top"}).click(function(){return o.scrollup(),!1}).appendTo("body"),document.all&&!window.XMLHttpRequest&&""!=o.$control.text()&&o.$control.css({width:o.$control.width()}),
						t('a[href="'+o.anchorkeyword+'"]').click(function(){return o.scrollup(),!1}),
